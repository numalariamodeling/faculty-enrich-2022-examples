...
from dtk.tools.climate.ClimateGenerator import ClimateGenerator  # for generate_climate
from simtools.SetupParser import SetupParser  # for generate_climate
...
if __name__ == '__main__':
    ...
    df = pd.DataFrame(data={'nodeid': [1], 'population': [1400], 'Village': ['Obom'],  'lat': [5.760759295941768], 'lon': [-0.4473415119456551]})

    demo_fname = os.path.join(inputs_path, 'my_demographics.json')
