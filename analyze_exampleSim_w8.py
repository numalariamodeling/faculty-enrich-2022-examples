...
expt_id = '048f5da6-6fda-ec11-a9f8-b88303911bc1'  ## change expt_id
...
def plot_individual_events(event_list,ip_name, sweep_variables):
    ...
    # 'date'
    adf = df.groupby(['Event_Name','Run_Number',ip_name] + sweep_variables )[['Individual_ID']].agg('count').reset_index().rename( columns={'Individual_ID': 'count'})
...
if __name__ == "__main__":
    ...
    ip_name = ['Access'] # takes single ip name only, otherwise needs to be dictionary
