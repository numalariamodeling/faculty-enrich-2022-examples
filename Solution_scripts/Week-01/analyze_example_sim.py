...
if __name__ == "__main__":
    ...
    if use_parse:
        ...
        expt_name = 'MR_FE_2022_example_w1'
        expt_id = '23a6e629-19c2-ec11-a9f6-9440c9be2c51'
        start_year = 0
        end_year = 6
    ...
    working_dir = os.path.join('./','simulation_outputs') ## assumes running from in ~faculty-enrich-2022-examples/Week-1/
